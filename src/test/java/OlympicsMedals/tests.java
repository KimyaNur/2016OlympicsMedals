...
//		List<WebElement> actualGold=driver.findElements(By.xpath("(//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr)/td[2]"));
//		
//		for(int i=1; i<actualGold.size()-1; i++) {
//		
//			int a=Integer.parseInt(driver.findElement(By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["+i+"]/td[2]")).getText());
//				gold.add(a);
//				if(a>max) {
//					max=a;
//					String name=driver.findElement(By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']//tbody//th//a["+i+"]")).getText();
//					maxname=name;
//				}
//		}
//		
//		System.out.println(maxname);
//		System.out.println(gold.get(0));
//		System.out.println(gold.get(1));
//		System.out.println(gold.get(2));
//	}
